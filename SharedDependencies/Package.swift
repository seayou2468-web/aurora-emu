...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "cereal", path: "Vendor/cereal", publicHeadersPath: "include"),
        .target(name: "cryptopp", path: "Vendor/cryptopp", publicHeadersPath: "include", cxxSettings: [
            .define("CRYPTOPP_DISABLE_ARM_CRC32"),
            .headerSearchPath("include/cryptopp")
        ]),
        .target(name: "dds_ktx", path: "Vendor/dds_ktx", publicHeadersPath: "include"),
        .target(name: "eventbus", path: "Vendor/eventbus", publicHeadersPath: "include"),
        .target(name: "glib", path: "Vendor/glib", publicHeadersPath: "include"),
        .target(name: "httplib", path: "Vendor/httplib", publicHeadersPath: "include"),
        .target(name: "inih", path: "Vendor/inih", publicHeadersPath: "include"),
        .target(name: "jwt", dependencies: [
            "OpenSSL"
        ], path: "Vendor/jwt", publicHeadersPath: "include"),
        .target(name: "libchdr", dependencies: [
            "FLAC",
            "ogg",
            .product(name: "PLzmaSDK-Static", package: "PLzmaSDK")
        ], path: "Vendor/libchdr", publicHeadersPath: "include"),
        .target(name: "libslirp", dependencies: [
            "glib"
        ], path: "Vendor/libslirp", publicHeadersPath: "include", cSettings: [
            .unsafeFlags([
                "-D_NETINET_TCP_VAR_H_",
                "-ffast-math"
            ])
        ]),
        .target(name: "lodepng", path: "Vendor/lodepng", publicHeadersPath: "include"),
        .target(name: "magic_enum", path: "Vendor/magic_enum", publicHeadersPath: "include"),
        .target(name: "metal_cpp", path: "Vendor/metal_cpp", publicHeadersPath: "include"),
        .target(name: "microprofile", path: "Vendor/microprofile", publicHeadersPath: "include"),
        .target(name: "miniz", path: "Vendor/miniz", publicHeadersPath: "include"),
        .target(name: "nihstro", path: "Vendor/nihstro", sources: [
            "parser_assembly"
        ...
        .target(name: "nlohmann", path: "Vendor/nlohmann", publicHeadersPath: "include"),
        .target(name: "oaknut", path: "Vendor/oaknut", publicHeadersPath: "include"),
        .target(name: "stb", path: "Vendor/stb", publicHeadersPath: "include"),
        .target(name: "toml", path: "Vendor/toml", publicHeadersPath: "include"),
        .target(name: "tsl", path: "Vendor/tsl", publicHeadersPath: "include"),
        .target(name: "xxhash", path: "Vendor/xxhash", publicHeadersPath: "include"),
