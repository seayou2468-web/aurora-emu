...
SERIALIZATION_CLASS_EXPORT_KEY(Service::PTM::PTM_S)
SERIALIZATION_CLASS_EXPORT_KEY(Service::PTM::PTM_Sysm)
SERIALIZATION_CONSTRUCT(Service::PTM::PTM_S)
SERIALIZATION_CONSTRUCT(Service::PTM::PTM_Sysm)
